...
- **[Gao Wang](https://www.neurology.columbia.edu/profile/gao-wang-phd)** – Principal Investigator who originally developed and hosted the pipeline using SoS workflow, available in [Github Bioworkflows Repository](https://github.com/cumc/bioworkflows).
